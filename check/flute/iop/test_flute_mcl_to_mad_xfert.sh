#!/bin/sh
#
# $Id: test_flute_mcl_to_mad_xfert.sh,v 1.2 2005/05/12 16:03:22 moi Exp $
#
...
echo ""
echo "$1 -A -m:225.1.2.3 -p:9991 -v:0 -s:${host_ip} -B:./"
echo "${flute_path} ${verbosity_send} -send -cc0 -fec1.0 -a225.1.2.3/9991 -phigh -demux1 ../Other_Files/i-am-a-BIG.file"
echo ""
...
rm -Rf ../files/recv/*
cd ../files/recv
$1 -A -m:225.1.2.3 -p:9991 -v:0 -s:${host_ip} -B:./&
flute_recv_pid=$!

cd ../send
../${flute_path} ${verbosity_send} -send -cc0 -fec1.0 -a225.1.2.3/9991 -demux1 -phigh ./Other_Files/i-am-a-BIG.file &
flute_send_pid=$!
...
diff ../files/send/Other_Files/i-am-a-BIG.file ../files/recv/Other_Files/i-am-a-BIG.file
...
echo ""
echo "$1 -A -U -m:127.0.0.1 -p:9998 -v:0 -s:127.0.0.1 -B:./"
echo "${flute_path} ${verbosity_send} -send -cc0 -fec1.0 -a127.0.0.1/9998 -demux1 -phigh ./Other_Files/i-am-a-BIG.file"
echo ""
...
rm -Rf ../files/recv/*
cd ../files/recv
$1 -A -U -m:127.0.0.1 -p:9998 -v:0 -s:127.0.0.1 -B:./ &
flute_recv_pid=$!

cd ../send
../${flute_path} ${verbosity_send} -send -cc0 -fec1.0 -a127.0.0.1/9998 -demux1 -phigh ./Other_Files/i-am-a-BIG.file &
flute_send_pid=$!
