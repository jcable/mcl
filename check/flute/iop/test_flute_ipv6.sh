#!/bin/sh
#
# $Id: test_flute_ipv6.sh,v 1.2 2005/05/12 16:03:20 moi Exp $
#
...
echo "** MCL to MAD "
echo ""
echo "$1 -A -m:ff01::1 -p:9991 -v:0 -a:IP6 -B:./"
echo "${flute_path} ${verbosity_recv} -send -cc0 -fec1.0 -aff01::1/9991 -demux1 -ifneth0 ./"
echo ""
...
rm -Rf ../files/recv/*
cd ../files/recv
$1 -A -m:ff01::1 -p:9991 -a:IP6 -v:0 -B:./&
flute_recv_pid=$!

cd ../send
../${flute_path} ${verbosity_recv} -send -cc0 -fec1.0 -aff01::1/9991 -demux1 -ifneth0 ./ &
flute_send_pid=$!
...
echo "** MAD to MCL "
echo ""
echo "${flute_path} ${verbosity_recv} -recv -aff01::1/9991 -ifneth0 -demux1"
echo "$1 -S -m:ff01::1 -p:9991 -v:0 -a:IP6 -F:../"
echo ""
...
rm -Rf ../files/recv/*
cd ../files/recv
../${flute_path} ${verbosity_recv} -recv -aff01::1/9991 -ifneth0 -demux1 &
flute_recv_pid=$!

cd ..
$1 -S -m:ff01::1 -p:9991 -v:0 -a:IP6 -F:./send &
flute_send_pid=$!
