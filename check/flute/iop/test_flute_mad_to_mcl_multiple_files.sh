#!/bin/sh
#
# $Id: test_flute_mad_to_mcl_multiple_files.sh,v 1.2 2005/05/12 16:03:21 moi Exp $
#
...
echo "$1 -S -m:225.1.2.3 -p:9991 -v:0 -F:../"
echo ""
...
cd ..
$1 -S -m:225.1.2.3 -p:9991 -v:0 -F:./send &
flute_send_pid=$!
...
echo "$1 -S -m:127.0.0.1 -p:9998 -v:0 -F:./"
echo ""
