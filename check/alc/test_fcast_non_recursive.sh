#!/bin/sh
#
# $Id: test_fcast_non_recursive.sh,v 1.3 2004/12/21 14:43:46 roca Exp $
#
...
cd fcast_test/recv
../../${fcast_path} ${verbosity_recv} -recv -never -phigh -a225.3.4.5/9998 &
fcast_recv_pid=$!

cd ../send
../../${fcast_path} ${verbosity_send} -send -phigh -a225.3.4.5/9998 ${file} &
fcast_send_pid=$!
