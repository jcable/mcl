#!/bin/sh
#
# $Id: test_flute_mad_to_mcl_fti_in_fdt.sh,v 1.2 2005/05/12 16:03:20 moi Exp $
#
...
echo ""
echo "** FTI in FDT with one big file..."
echo ""
echo "${flute_path} ${verbosity_recv} -recv -a225.1.2.3/9991 -demux1"
echo "$1 -S -m:225.1.2.3 -p:9991 -v:0 -e:0 -F:../Other_Files/i-am-a-BIG.file"
echo ""
...
cd ../send
$1 -S -m:225.1.2.3 -p:9991 -v:0 -e:0 -F:./Other_Files/i-am-a-BIG.file &
flute_send_pid=$!
...
#
# and now with several files...
#

echo ""
echo "** FTI in FDT with several files..."
echo ""
echo "${flute_path} ${verbosity_recv} -recv -a225.1.2.3/9991 -demux1"
echo "$1 -S -m:225.1.2.3 -p:9991 -v:0 -e:0 -F:../"
echo ""
...
cd ../
$1 -S -m:225.1.2.3 -p:9991 -v:0 -e:0 -F:./send/ &
flute_send_pid=$!
