#!/bin/sh
#
# $Id: test_flute_FEC.sh,v 1.2 2005/05/12 16:03:19 moi Exp $
#
...
echo ""
echo "** MCL to MAD using RSE"
echo ""
echo "$1 -A -m:225.1.2.3 -p:9991 -v:0 -s:${host_ip} -B:./"
echo "${flute_path} ${verbosity_recv} -send -cc0 -fec2.0 -a225.1.2.3/9991 -demux1 ./"
echo ""
...
cd ../send
../${flute_path} ${verbosity_recv} -send -cc0 -fec2.0 -a225.1.2.3/9991 -demux1 ./ &
flute_send_pid=$!
...
cd ..
$1 -S -m:225.1.2.3 -p:9991 -v:0 -x:2 -F:./send &
flute_send_pid=$!
