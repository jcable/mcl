/* $Id: mcl_fec.cpp,v 1.3 2003/12/19 13:36:10 roca Exp $ */
/*
...
mcl_fec::initialize (const INT32	new_code)
{
	...
	case MCL_FEC_CODE_RSE:
		...
		this->cur_k[MCL_FEC_CODE_RSE] = RSE_DEFAULT_K;
		this->cur_n[MCL_FEC_CODE_RSE] = RSE_DEFAULT_N;
		 ...
		 mcl_block	*blk)
{
	...
	//this->set_fec_code (mclcb, MCL_FEC_CODE_LDGM);
	this->fec_codec = MCL_FEC_CODE_LDGM;
	/*
