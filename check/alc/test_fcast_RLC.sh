#!/bin/sh
#
# $Id: test_fcast_RLC.sh,v 1.2 2004/12/21 14:43:46 roca Exp $
#
...
#
# fcast test sending a single file with RLC congestion control mode, without giving any path
#
#
host_name=`uname -s`
...
echo "${fcast_path} ${verbosity_recv} -recv -a225.1.2.3/9991 -never -ospeed -cc1 -p1024"
echo "${fcast_path} ${verbosity_send} -send -a225.1.2.3/9991 -ospeed -cc1 -p1024/1000000 -fec1.5 i-am-a-BIG.file"
echo ""
