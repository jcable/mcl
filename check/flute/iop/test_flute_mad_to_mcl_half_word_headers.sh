#!/bin/sh
#
# $Id: test_flute_mad_to_mcl_half_word_headers.sh,v 1.2 2005/05/12 16:03:21 moi Exp $
#
...
cd ..
$1 -S -m:225.1.2.3 -p:9991 -H -v:0 -F:./send &
flute_send_pid=$!
